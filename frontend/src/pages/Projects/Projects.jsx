...
function Projects() {
  ...
  return (
    <section className="w-full sm:w-full bg-neutral-900  text-white  lg:pt-15 pb-5">
     <div >
      ...
      <div>
        <div className=" gap-4 mt-10 w-full  p-4 ">
          <ul className="   flex items-center justify-center gap-5 text-md font-bold">
        ...
        <div  className="min-h-screen w-full  bg-neutral-900 text-white  pt-5 ">
          <div className="w-full flex justify-center">
            <div className="grid grid-col-1 lg:grid-cols-3 md:grid-cols-2  sm:grid-cols-1 gap-8 w-95% mx-auto ">
      ...
      <div className="text-center font-bold text-white">
        <button class="text-xl mt-10 sm:mt-0 bg-gradient-to-r from-[#3A86FF] to-[#FF006E] transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 w-50 h-20 rounded-2xl">
          Load More Projects
        </button>
      </div>
     </div>
