...
export default function LocationCard() {
  return (
    <div className="bg-[#1a1a1a] rounded-2xl p-12 text-center shadow-xl relative overflow-hidden min-h-[250px] flex flex-col justify-center items-center">
      ...
      {/* Icon */}
      <div className="relative z-10 bg-blue-600/20 p-4 rounded-full mb-4">
