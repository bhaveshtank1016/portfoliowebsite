    ...
    <div className="bg-neutral-800 rounded-2xl overflow-hidden shadow-lg w-full max-w-md">
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between mt-6 text-sm">
          <a href={project.demo} target="_blank" rel="noreferrer" className="text-blue-400 hover:underline flex items-center gap-1">
            Live Demo <FaExternalLinkAlt />
          </a>
          <a href={project.github} target="_blank" rel="noreferrer" className="text-pink-500 hover:underline flex items-center gap-1">
            GitHub <FaGithub />
          </a>
        </div>
      </div>
